...
// `public/sign/welcome.vtt`). Until then this component renders nothing, so the
// app never shows a placeholder. We never fabricate or auto-generate sign language.
