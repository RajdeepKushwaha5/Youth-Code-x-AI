...
assert(await evaluate("document.body.textContent.includes('write it your way.') && document.body.textContent.includes('see how English changes.')"), 'hero message is missing')
