...
- **Evaluation.** A deterministic exact-match check handles obvious answers without a model call; otherwise the model evaluates meaning preservation and correct skill use.
